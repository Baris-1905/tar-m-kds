...
# Başlık
st.title("Hınıs Tarımı İçin Gelişmiş Karar Destek Sistemi")
...
if st.button("Hesapla"):
    # Karar destek algoritması (güncellenmiş)
    ...
    st.markdown(f"**Ekim Zamanı:** {sonuc['ekim_zamani']}")
    st.markdown(f"**Gübre Tavsiyesi:** {sonuc['gubre_tavsiyesi']}")
    st.markdown(f"**Tahmini Verim:** {sonuc['tahmini_verim_kg_da']} kg/da")
    if "uyari" in sonuc:
